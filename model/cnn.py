...
Config parameters (all injectable so the GA can tune them):
  ...
  - input_channels: int  — input image channels (default 3 for RGB)
"""
...
def build_model(config: dict) -> nn.Module:
    """Build a SimpleCNN from a config dict (called by train.py and the GA fitness function)."""
    return SimpleCNN(
